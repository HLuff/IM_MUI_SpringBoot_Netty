window.app = {
	 ...
	 * netty服务后端发布的url地址
	 */
	//"ws://192.168.77.1:8088/ws"
	nettyServerUrl:"ws://192.168.199.249:8088/ws",

	
	/**
	 * 后端服务发布的url地址
	 */
	//serverUrl: 'http://192.168.0.113:8080',
	serverUrl: 'http://192.168.199.249:8080',

	
	/**
	 * 图片服务器的url地址
	 */
	//imgServerUrl: 'http://192.168.0.113:5088/imooc/',
	imgServerUrl: 'http://192.168.199.249:5088/imooc/',
	...
	/**
	 * 封装消息提示框，默认的mui的不支持居中和自定义icon，所以使用h5+
	 * @param {Object} msg
	 * @param {Object} type
	 */
